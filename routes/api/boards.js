...
router.post("/add", authenticate, validateBody(addBoardSchema), boardsController.addBoard);
router.patch("/:id", authenticate,validateBody(updateBoardSchema), boardsController.updateBoard);
